  ...
  return (
    ...
    >
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl rounded-3xl border border-border/50 bg-card/35 p-8 text-center shadow-card backdrop-blur-md transition-shadow duration-500 hover:shadow-card-hover md:p-12">
          <Reveal>
